...
#if UNITY_ANDROID
        string adUnitId = "ca-app-pub-6161839732693205/3452968114";//ここにAndroidのインタースティシャル広告IDを入力

#elif UNITY_IPHONE
        string adUnitId = "ca-app-pub-6161839732693205/9116907078";//ここにiOSのインタースティシャル広告IDを入力
